...
sudo dnf install fastfetch -y; sudo dnf install foomatic -y; sudo dnf install java-latest-openjdk -y; sudo dnf install gnome-disks -y; sudo dnf install lshw-gui -y; sudo dnf install lsd -y;
