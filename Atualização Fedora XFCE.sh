...
#sudo dnf install kdenlive -y; sudo dnf install transmission -y; sudo dnf install mediawriter -y; sudo dnf install gedit -y; sudo dnf install audacious -y; sudo dnf install asunder -y; sudo dnf install tuxguitar -y; sudo dnf install thunderbird -y; sudo dnf install wine -y;
