...
#sudo dnf install fastfetch -y; sudo dnf install foomatic -y; sudo dnf install simple-scan -y; sudo dnf install java-latest-openjdk -y; sudo dnf install btop -y; sudo dnf install gnome-boxes -y; sudo dnf install krusader -y; sudo dnf install flatpak -y; sudo dnf install kitty -y; 
