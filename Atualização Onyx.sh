...
#rpm-ostree install fastfetch; rpm-ostree install simple-scan; rpm-ostree install lshw-gui; rpm-ostree install java-latest-openjdk; rpm-ostree install btop; rpm-ostree install kitty; rpm-ostree install boxes; rpm-ostree install emacs; rpm-ostree install lsd; rpm-ostree install foomatic;
