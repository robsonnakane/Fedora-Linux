...
#rpm-ostree install fastfetch; rpm-ostree install foomatic; rpm-ostree install simple-scan; rpm-ostree install lshw-gui; rpm-ostree install gnome-tweaks; rpm-ostree install java-latest-openjdk; rpm-ostree install btop; rpm-ostree install kitty; rpm-ostree install boxes;
