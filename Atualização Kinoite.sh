...
#rpm-ostree install neofetch; rpm-ostree install simple-scan; rpm-ostree install lshw-gui; rpm-ostree install java-latest-openjdk; rpm-ostree install btop; rpm-ostree install kitty; rpm-ostree install boxes; rpm-ostree install gnome-disk-utility; rpm-ostree install lsd; rpm-ostree install kate; rpm-ostree install krusader; rpm-ostree install thunderbird; rpm-ostree install kcalc; rpm-ostree install krename; rpm-ostree install kget; rpm-ostree install transmission;
